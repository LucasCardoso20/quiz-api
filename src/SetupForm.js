    ...
    <section className='quiz quiz-small'>
      <form className='setup-form'>
        ...
        <div className='form-control'>
          ...
          <input type='number' name='amount' id='amount' value={quiz.amount} onChange={handleChange} className="form-input" min={1} max={15}/>
        </div>
        ...
        <button type='submt' onClick={handleSubmit} className="submit-btn">start</button>
      </form>
    </section>
  </main>
}
